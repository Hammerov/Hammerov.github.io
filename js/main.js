...
function commander(cmd) {
  switch (cmd.toLowerCase()) {
    ...
    case "sudo":
      ...
      break;
    case "admin":
    addLine("Did you really think this would work?...", "color2", 80);
    setTimeout(function() {
        window.open('https://www.youtube.com/watch?v=y0e6DlfPrYE');
      }, 1000); 
      break;
    case "social":
    ...
    case "history":
      ...
      break;
    case "email":
      addLine('Opening mailto:<a href="mailto:hamzaliyakatali@gmail.com">hamzaliyakatali@gmail.com</a>...', "color2", 80);
      newTab(email);
      break;
    case "clear":
      setTimeout(function() {
